...
__all__ = ['NoSqlAttributeInspectorTestCase',
...
class RdbAttributeInspectorTestCase(RdbTestCaseMixin, ResourceTestCase):
...
if HAS_MONGO:
    class NoSqlAttributeInspectorTestCase(NoSqlTestCaseMixin,
                                          ResourceTestCase):
        package_name = 'everest.tests.complete_app'
