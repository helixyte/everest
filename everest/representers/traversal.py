...
class DataElementDataTraversalProxy(ConvertingDataTraversalProxyMixin,
    ...
    def __init__(self, data, accessor, relationship_direction,
                 relation_operation, attribute_key=None, mapping=None):
        """
    ...
    def set_relationship(self, attribute, relationship):
        ...
        attribute.
        """
        self.__relationships[attribute.entity_attr] = relationship
    ...
    def __get_relatee(self, attribute):
        try:
            rel = self.__relationships[attribute.entity_attr]
        except KeyError:
